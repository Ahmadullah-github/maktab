...
- [ ] 8. Extract variable creation to `core/variables.py`
  - [ ] 8.1 Create VariableManager class with variable creation methods
  ...
  - [ ] 8.2 Write property test for variable pool reuse
    - **Property 13: Variable Pool Reuse**
    - **Validates: Requirements 6.4**

- [ ] 9. Extract solution building to `core/solution_builder.py`
  - [ ] 9.1 Create SolutionBuilder class
    - Implement `build_solution()` method
    - Implement `add_metadata()` method
    - _Requirements: 1.3_
  - [ ] 9.2 Write unit tests for solution builder
    - Test solution construction from solver values
    - Test metadata generation
    - _Requirements: 1.3_

- [ ] 10. Refactor main solver in `core/solver.py`
  - [ ] 10.1 Create refactored TimetableSolver class
  ...
  - [ ] 10.2 Write property test for solver output equivalence
...
- [ ] 12. Implement configuration system
  - [ ] 12.1 Create `config/schema.py` with configuration Pydantic models
    - Define DecompositionConfig, StrategyConfig, MemoryConfig, SolverConfig
    - _Requirements: 3.1, 3.2, 3.3, 3.4_
  - [ ] 12.2 Create `config/loader.py` with ConfigLoader class
    - Implement YAML loading from multiple search paths
    - Implement environment variable overrides
    - Implement `save()` method for serialization
    - _Requirements: 3.1, 3.5_
  - [ ] 12.3 Write property test for configuration round-trip
    - **Property 4: Configuration Round-Trip**
    - **Validates: Requirements 3.6, 10.2**
  - [ ] 12.4 Write property test for configuration override
    - **Property 5: Configuration Override**
    - **Validates: Requirements 3.2, 3.3, 3.4**
  - [ ] 12.5 Write property test for environment variable override
...
- [ ] 14. Implement parallel cluster solving
  - [ ] 14.1 Create `parallel/executor.py` with ParallelClusterExecutor class
  ...
  - [ ] 14.2 Write property test for parallel worker count
    - **Property 6: Parallel Worker Count**
    - **Validates: Requirements 4.2**
  - [ ] 14.3 Write property test for parallel failure isolation
    - **Property 7: Parallel Failure Isolation**
    - **Validates: Requirements 4.3**
  - [ ] 14.4 Write property test for solution merge correctness
    - **Property 8: Solution Merge Correctness**
    - **Validates: Requirements 4.4**

- [ ] 15. Implement checkpoint/resume capability
  - [ ] 15.1 Create `parallel/checkpoint.py` with CheckpointManager class
    - Implement `save()`, `load()`, `delete()`, `validate()` methods
    - Use pickle for serialization
    - _Requirements: 5.1, 5.2, 5.3, 5.4, 5.5_
  - [ ] 15.2 Write property test for checkpoint completeness
    - **Property 9: Checkpoint Completeness**
    - **Validates: Requirements 5.1, 5.2**
  - [ ] 15.3 Write property test for checkpoint resume correctness
    - **Property 10: Checkpoint Resume Correctness**
    - **Validates: Requirements 5.3**
  - [ ] 15.4 Write property test for checkpoint validation
...
- [ ] 17. Implement memory management
  - [ ] 17.1 Create `memory/manager.py` with MemoryManager class
    - Implement memory limit checking
    - Implement GC triggering at threshold
    - Implement variable pool management
    - _Requirements: 6.1, 6.2, 6.3, 6.4, 6.5_
  - [ ] 17.2 Write property test for memory limit enforcement
...
- [ ] 19. Implement metrics export
  - [ ] 19.1 Create `metrics/prometheus.py` with MetricsExporter class
    - Define Histogram, Counter, Gauge metrics
    - Implement recording methods
    - Implement Prometheus format export
    - _Requirements: 9.1, 9.2, 9.3, 9.4_
  - [ ] 19.2 Write property test for metrics counter increment
    - **Property 17: Metrics Counter Increment**
    - **Validates: Requirements 9.2**

- [ ] 20. Implement queue worker
  - [ ] 20.1 Create `queue/worker.py` with SolverWorker class
    - Implement Redis queue consumption
    - Implement result storage
    - Implement retry logic
    - _Requirements: 8.1, 8.2, 8.3, 8.4_
  - [ ] 20.2 Create `queue/job.py` with SolverJob and SolverResult models
    - Define job and result schemas
    - _Requirements: 8.1_
  - [ ] 20.3 Write property test for queue result storage
    - **Property 15: Queue Result Storage**
    - **Validates: Requirements 8.2**
  - [ ] 20.4 Write property test for queue retry logic
...
- [ ] 22. Create Docker configuration
  - [ ] 22.1 Create `Dockerfile.solver` for solver container
    - Use python:3.12-slim base image
    - Include health check
    - Configure entrypoint
    - _Requirements: 7.1, 7.2_
  - [ ] 22.2 Update `docker-compose.yml` with solver service
    - Configure resource limits (CPU, memory)
    - Configure environment variables
    - _Requirements: 7.3, 7.4_
  - [ ] 22.3 Write integration test for containerized solver
...
- [ ] 24. Implement remaining property tests
  - [ ] 24.1 Write property test for grade category validity
    - **Property 18: Grade Category Validity**
    - **Validates: Requirements 10.1**
  - [ ] 24.2 Write property test for decomposition partition
    - **Property 20: Decomposition Partition**
    - **Validates: Requirements 10.4**

## Phase 10: Integration and Entry Point

- [ ] 25. Create entry point and wire everything together
  - [ ] 25.1 Create `solver.py` entry point
    - Wire all modules together
    - Maintain backward compatibility with stdin/stdout interface
    - _Requirements: 1.1, 1.8_
  - [ ] 25.2 Update `__init__.py` files for proper exports
    - Export public APIs from each module
    - _Requirements: 1.1_
  - [ ] 25.3 Write integration tests for full solve workflow
