...
log = get_logger("solver.cluster_builder")
...
class ClassClusterBuilder:
    ...
    def _create_cluster_metadata(
        self, class_ids: Set[str], cluster_id: int
    ) -> Dict[str, Any]:
        """
    ...
    def create_sub_problem_data(self, cluster: Dict[str, Any]):
        ...
        sub_data.teachers = [
            t for t in sub_data.teachers if t.id in cluster_teacher_ids
        ]
        ...
        log.info(
            f"Created sub-problem for cluster {cluster['cluster_id']}",
