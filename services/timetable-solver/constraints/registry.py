...
class ConstraintRegistry:
    ...
    def register(self, constraint: Constraint, stage: ConstraintStage | None = None) -> None:
    ...
    def apply_all(
        self, model: cp_model.CpModel, context: dict[str, Any], stage: ConstraintStage
    ) -> list[Any]:
    ...
    def get_constraints(self, stage: ConstraintStage | None = None) -> list[Constraint]:
