...
""",
    ...
    parser.add_argument("--database", "-d", type=Path, default=Path(os.environ.get("DATABASE_PATH", DEFAULT_DATABASE)), help="SQLite file (default: DATABASE_PATH or services/local-api/timetable.db)")
