...
class ProgressReporter:
    ...
    def __init__(self) -> None:
        ...
        self.current_stage: SolveStage | None = None

    def _estimate_remaining(self, overall_percent: float) -> int | None:
    ...
    def report_stage(self, stage: SolveStage, percent_within_stage: float = 0.0) -> None:
        ...
        # Write to stderr to avoid mixing with JSON output on stdout
