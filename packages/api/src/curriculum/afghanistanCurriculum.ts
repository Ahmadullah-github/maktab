 ...
 * - Beta-Primary: Grades 4-6 (32 periods/week)
 * - Middle: Grades 7-9 (42 periods/week)
 * - High: Grades 10-12 (42 periods/week)
 */
...
export interface SubjectDefinition {
  ...
  requiredRoomType?: string; // e.g., "Science Lab", "Computer Lab"
...
export const MINISTRY_CURRICULUM: GradeSubjects = {
  grade_1: [
    ...
    { name: "تعلیم و تربیه اسلامی", nameEn: "Islamic Studies", code: "اسل۱", periodsPerWeek: 5, isCore: true },
  ...
  grade_2: [
    ...
    { name: "تعلیم و تربیه اسلامی", nameEn: "Islamic Studies", code: "اسل۲", periodsPerWeek: 5, isCore: true },
  ...
  grade_3: [
    ...
    { name: "تعلیم و تربیه اسلامی", nameEn: "Islamic Studies", code: "اسل۳", periodsPerWeek: 5, isCore: true },
  ...
  grade_4: [
    ...
    { name: "ریاضی", nameEn: "Mathematics", code: "ریض۴", periodsPerWeek: 5, isDifficult: true, isCore: true },
    { name: "تعلیم و تربیه اسلامی", nameEn: "Islamic Studies", code: "اسل۴", periodsPerWeek: 4, isCore: true },
  ...
  grade_5: [
    ...
    { name: "ریاضی", nameEn: "Mathematics", code: "ریض۵", periodsPerWeek: 5, isDifficult: true, isCore: true },
    { name: "تعلیم و تربیه اسلامی", nameEn: "Islamic Studies", code: "اسل۵", periodsPerWeek: 4, isCore: true },
  ...
  grade_6: [
    ...
    { name: "ریاضی", nameEn: "Mathematics", code: "ریض۶", periodsPerWeek: 5, isDifficult: true, isCore: true },
    { name: "تعلیم و تربیه اسلامی", nameEn: "Islamic Studies", code: "اسل۶", periodsPerWeek: 4, isCore: true },
  ...
  grade_7: [
    { name: "ریاضی", nameEn: "Mathematics", code: "ریض۷", periodsPerWeek: 5, isDifficult: true, isCore: true },
    ...
    { name: "تعلیم و تربیه اسلامی", nameEn: "Islamic Studies", code: "اسل۷", periodsPerWeek: 3, isCore: true },
    ...
    { name: "بیولوژی", nameEn: "Biology", code: "بیو۷", periodsPerWeek: 2, requiredRoomType: "Science Lab" },
  ...
  ], // Total: 36 periods (adjusted)

  grade_8: [
    { name: "ریاضی", nameEn: "Mathematics", code: "ریض۸", periodsPerWeek: 5, isDifficult: true, isCore: true },
    ...
    { name: "تعلیم و تربیه اسلامی", nameEn: "Islamic Studies", code: "اسل۸", periodsPerWeek: 3, isCore: true },
    { name: "قرآن‌کریم", nameEn: "Holy Quran", code: "قرآ۸", periodsPerWeek: 3, isCore: true },
    { name: "فزیک", nameEn: "Physics", code: "فزی۸", periodsPerWeek: 3, isDifficult: true, requiredRoomType: "Science Lab" },
    { name: "کیمیا", nameEn: "Chemistry", code: "کیم۸", periodsPerWeek: 3, isDifficult: true, requiredRoomType: "Science Lab" },
    { name: "بیولوژی", nameEn: "Biology", code: "بیو۸", periodsPerWeek: 2, requiredRoomType: "Science Lab" },
  ...
  grade_9: [
    { name: "ریاضی", nameEn: "Mathematics", code: "ریض۹", periodsPerWeek: 5, isDifficult: true, isCore: true },
    ...
    { name: "تعلیم و تربیه اسلامی", nameEn: "Islamic Studies", code: "اسل۹", periodsPerWeek: 3, isCore: true },
    { name: "قرآن‌کریم", nameEn: "Holy Quran", code: "قرآ۹", periodsPerWeek: 3, isCore: true },
    { name: "فزیک", nameEn: "Physics", code: "فزی۹", periodsPerWeek: 3, isDifficult: true, requiredRoomType: "Science Lab" },
    { name: "کیمیا", nameEn: "Chemistry", code: "کیم۹", periodsPerWeek: 3, isDifficult: true, requiredRoomType: "Science Lab" },
    { name: "بیولوژی", nameEn: "Biology", code: "بیو۹", periodsPerWeek: 2, requiredRoomType: "Science Lab" },
  ...
  grade_10: [
    { name: "ریاضی", nameEn: "Mathematics", code: "ریض۱۰", periodsPerWeek: 6, isDifficult: true, isCore: true },
    { name: "دری", nameEn: "Dari Language", code: "دری۱۰", periodsPerWeek: 3, isDifficult: true, isCore: true },
    ...
    { name: "تعلیم و تربیه اسلامی", nameEn: "Islamic Studies", code: "اسل۱۰", periodsPerWeek: 3, isCore: true },
    { name: "تفسیر", nameEn: "Tafsir", code: "تفس۱۰", periodsPerWeek: 3, isCore: true },
    { name: "فزیک", nameEn: "Physics", code: "فزی۱۰", periodsPerWeek: 3, isDifficult: true, requiredRoomType: "Science Lab" },
    { name: "کیمیا", nameEn: "Chemistry", code: "کیم۱۰", periodsPerWeek: 3, isDifficult: true, requiredRoomType: "Science Lab" },
    { name: "بیولوژی", nameEn: "Biology", code: "بیو۱۰", periodsPerWeek: 2, requiredRoomType: "Science Lab" },
    { name: "جیولوژی", nameEn: "Geology", code: "جیو۱۰", periodsPerWeek: 2, requiredRoomType: "Science Lab" },
    ...
    { name: "کمپیوتر", nameEn: "Computer", code: "کمپ۱۰", periodsPerWeek: 2, requiredRoomType: "Computer Lab" },
  ], // Total: 36 periods

  grade_11: [
    { name: "ریاضی", nameEn: "Mathematics", code: "ریض۱۱", periodsPerWeek: 6, isDifficult: true, isCore: true },
    { name: "دری", nameEn: "Dari Language", code: "دری۱۱", periodsPerWeek: 3, isDifficult: true, isCore: true },
    ...
    { name: "تعلیم و تربیه اسلامی", nameEn: "Islamic Studies", code: "اسل۱۱", periodsPerWeek: 4, isCore: true },
    { name: "تفسیر", nameEn: "Tafsir", code: "تفس۱۱", periodsPerWeek: 3, isCore: true },
    { name: "فزیک", nameEn: "Physics", code: "فزی۱۱", periodsPerWeek: 3, isDifficult: true, requiredRoomType: "Science Lab" },
    { name: "کیمیا", nameEn: "Chemistry", code: "کیم۱۱", periodsPerWeek: 3, isDifficult: true, requiredRoomType: "Science Lab" },
    { name: "بیولوژی", nameEn: "Biology", code: "بیو۱۱", periodsPerWeek: 3, requiredRoomType: "Science Lab" },
    ...
    { name: "کمپیوتر", nameEn: "Computer", code: "کمپ۱۱", periodsPerWeek: 2, requiredRoomType: "Computer Lab" },
  ], // Total: 36 periods

  grade_12: [
    { name: "ریاضی", nameEn: "Mathematics", code: "ریض۱۲", periodsPerWeek: 6, isDifficult: true, isCore: true },
    { name: "دری", nameEn: "Dari Language", code: "دری۱۲", periodsPerWeek: 3, isDifficult: true, isCore: true },
    ...
    { name: "تعلیم و تربیه اسلامی", nameEn: "Islamic Studies", code: "اسل۱۲", periodsPerWeek: 4, isCore: true },
    { name: "تفسیر", nameEn: "Tafsir", code: "تفس۱۲", periodsPerWeek: 3, isCore: true },
    { name: "فزیک", nameEn: "Physics", code: "فزی۱۲", periodsPerWeek: 3, isDifficult: true, requiredRoomType: "Science Lab" },
    { name: "کیمیا", nameEn: "Chemistry", code: "کیم۱۲", periodsPerWeek: 3, isDifficult: true, requiredRoomType: "Science Lab" },
    { name: "بیولوژی", nameEn: "Biology", code: "بیو۱۲", periodsPerWeek: 3, requiredRoomType: "Science Lab" },
    ...
    { name: "کمپیوتر", nameEn: "Computer", code: "کمپ۱۲", periodsPerWeek: 2, requiredRoomType: "Computer Lab" },
  ], // Total: 36 periods
};
