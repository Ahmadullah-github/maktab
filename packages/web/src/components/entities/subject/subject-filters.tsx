    ...
    <div className="space-y-4 mb-6">
      ...
      <div className={cn(
        ...
        <div className="relative flex-1">
          ...
          <Input
            type="text"
            placeholder={isRTL ? "جستجوی مواد درسی..." : "Search subjects..."}
            value={searchTerm}
      ...
      <div className="space-y-2">
        ...
        <div className={cn(
          ...
          <Badge
            variant={selectedDifficulty === "difficult" ? "default" : "outline"}
            className={cn(
              "cursor-pointer hover:bg-primary/90 transition-colors px-4 py-2",
              selectedDifficulty === "difficult" && "bg-amber-500 text-white hover:opacity-90"
            )}
            onClick={() => onDifficultyChange("difficult")}
          >
            {isRTL ? "دشوار" : "Difficult"}
          </Badge>
          <Badge
            variant={selectedDifficulty === "regular" ? "default" : "outline"}
            className="cursor-pointer hover:bg-primary/90 transition-colors px-4 py-2"
            onClick={() => onDifficultyChange("regular")}
          >
            {isRTL ? "عادی" : "Regular"}
          </Badge>
        </div>
