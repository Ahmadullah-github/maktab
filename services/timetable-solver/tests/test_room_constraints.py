        ...
        "teachers": [
            {
                ...
                "availability": {"Saturday": teacher_availability or [True] * period_count},
...
class RoomSolverConstraintTests(unittest.TestCase):
    ...
    def test_selected_room_must_be_available_for_full_duration(self):
        ...
        payload["rooms"][1]["unavailable"] = [{"day": "Saturday", "periods": [0]}]
    ...
    def test_short_remainder_gets_its_own_start_domain(self):
        ...
        payload["rooms"][0]["unavailable"] = [{"day": "Sunday", "periods": [0]}]
        payload["rooms"][1]["unavailable"] = [{"day": "Saturday", "periods": [0, 1]}]
