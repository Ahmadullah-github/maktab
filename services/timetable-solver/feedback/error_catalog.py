...
ERROR_DEFINITIONS: dict[ErrorCode, ErrorDefinition] = {
    ...
    ErrorCode.TEACHER_AVAILABILITY_CONFLICT: ErrorDefinition(
        ...
        message_farsi_template=(
            "استاد {teacherName} در هیچ یک از ساعات مورد نیاز برای {subjectName} در دسترس نیست"
        ),
        message_english_template=(
    ...
    ErrorCode.MISSING_ROOM_TYPE: ErrorDefinition(
        ...
        message_english_template=(
            "Subject {subjectName} requires room type '{roomType}', but no room of this type exists"
        ),
    ...
    ErrorCode.NO_FEASIBLE_SOLUTION: ErrorDefinition(
        ...
        message_farsi_template=(
            "با محدودیت‌های فعلی امکان ایجاد جدول زمانی وجود ندارد. لطفاً محدودیت‌ها را بررسی کنید"
        ),
        message_english_template=(
