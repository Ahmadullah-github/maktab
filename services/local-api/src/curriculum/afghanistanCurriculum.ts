 ...
 *
 * This data is an optional starting point for a school-owned curriculum. It has
 * no validation or solver authority.
 *
 * Grade Categories:
...
export interface SubjectDefinition {
  ...
  periodsPerWeek: number; // Suggested periods in the optional template
  isDifficult?: boolean; // Affects scheduling (avoid back-to-back)
  requiredRoomType?: string; // e.g., "lab", "computer_lab"
  isCore?: boolean; // Informational template metadata only
  isCustom?: boolean;
...
// ==============================================================================
// Optional Afghanistan Reference Template
// ==============================================================================
