...
const GRADE_CATEGORIES = {
  'Alpha-Primary': { description: 'Primary (Grades 1-3)', descriptionFa: 'ابتدایی الف (صنف ۱-۳)', grades: [1, 2, 3] },
  'Beta-Primary': { description: 'Primary (Grades 4-6)', descriptionFa: 'ابتدایی ب (صنف ۴-۶)', grades: [4, 5, 6] },
  Middle: { description: 'Middle (Grades 7-9)', descriptionFa: 'متوسطه (صنف ۷-۹)', grades: [7, 8, 9] },
  High: { description: 'High (Grades 10-12)', descriptionFa: 'لیسه (صنف ۱۰-۱۲)', grades: [10, 11, 12] },
} as const;
