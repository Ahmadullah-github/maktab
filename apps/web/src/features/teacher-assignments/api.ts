...
export const teacherAssignmentsApi = {
  ...
  async getAll(): Promise<TeacherClassSubjectAssignment[]> {
    return fetchAPI<TeacherClassSubjectAssignment[]>('/assignments');
  },
  ...
  async getByClass(classId: number): Promise<TeacherClassSubjectAssignment[]> {
    return fetchAPI<TeacherClassSubjectAssignment[]>(`/assignments?classId=${classId}`);
  },
  ...
  async getByTeacher(teacherId: number): Promise<TeacherClassSubjectAssignment[]> {
    return fetchAPI<TeacherClassSubjectAssignment[]>(`/assignments?teacherId=${teacherId}`);
  },
