...
from models.input import ClassGroup, DayOfWeek, TimetableData
...
class VariableManager:
    ...
    def __init__(
        ...
        self._is_assigned_cache: dict[tuple[int, int | None, int | None], cp_model.IntVar] = {}
    ...
    def get_or_create_int_var(
        self, key: str, lower_bound: int, upper_bound: int
    ) -> cp_model.IntVar:
        """
    ...
    def get_or_create_variable(self, pool_name: str, key: str, factory: Callable[[], T]) -> T:
        """
    ...
    def compute_allowed_starts(
        self, c_idx: int, allowed_teachers: list[int], allowed_rooms: list[int], length: int
    ) -> list[int]:
        """
    ...
    def cache_allowed_domain(self, class_id: str, subject_id: str, domain: dict[str, Any]) -> None:
        """
    ...
    def create_start_variables(
        self, requests: list[dict[str, Any]], allowed_domains: dict[tuple[str, str], dict[str, Any]]
    ...
    def create_interval_variables(
        self, requests: list[dict[str, Any]], start_vars: list[cp_model.IntVar]
    ) -> tuple[
